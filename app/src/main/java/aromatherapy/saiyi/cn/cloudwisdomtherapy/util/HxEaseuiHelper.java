...
import aromatherapy.saiyi.cn.cloudwisdomtherapy.domain.RobotUser;
...
//        }
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    ...
                    if (hxIdFrom.equals(MyApplication.newInstance().getToChatUsername()) || message.getTo().equals(MyApplication.newInstance().getToChatUsername())) {
                        ...
                        simpleNotification(mas, hxIdFrom);
                        Log.e("Helper", hxIdFrom + " " + mas);
                    }
    ...
    private void simpleNotification(String msg, String ToChatUsername) {
        ...
        PendingIntent pendingIntent3 = PendingIntent.getActivity(appContext, 0,
                new Intent(appContext, ChatActivity.class).putExtra("ToChatUsername", ToChatUsername), 0);
        // 通过Notification.Builder来创建通知，注意API Level
        // API16之后才支持
        Notification notify3 = new Notification.Builder(appContext)
